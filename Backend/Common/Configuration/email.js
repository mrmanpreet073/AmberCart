...
// ── Base send function (replaces nodemailer transporter.sendMail) ──
...
// ── Verification email (unchanged HTML — just swapped transport) ──
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); border: 1px solid #e5e7eb; overflow: hidden;">
                <tr>
                    <td style="padding: 40px 32px; text-align: center;">
                        ...
                        <a href="${url}" style="background-color: #d97706; color: #ffffff; display: inline-block; font-size: 16px; font-weight: 600; line-height: 48px; text-align: center; text-decoration: none; width: 200px; border-radius: 6px; -webkit-text-size-adjust: none;">Verify Email</a>
...
// ── Reset password email (unchanged HTML — just swapped transport) ──
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); border: 1px solid #e5e7eb; overflow: hidden;">
                <tr>
                    <td style="padding: 40px 32px; text-align: center;">
                        ...
                        <div style="background-color: #fef3c7; border: 2px solid #d97706; border-radius: 6px; padding: 16px 32px; margin-bottom: 24px; display: inline-block; font-size: 36px; font-weight: 700; letter-spacing: 6px; color: #92400e;">
                            ${otp}
                        </div>

                        <p style="color: #9ca3af; font-size: 14px; line-height: 20px; margin-top: 32px; margin-bottom: 0;">If you didn't request a password reset, you can safely ignore this email. Do not share this OTP with anyone.</p>
                    </td>
                </tr>
            </table>
        </div>
